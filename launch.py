...
commandline_args = os.environ.get('set COMMANDLINE_ARGS= --allow-code --no-half-vae --api --ckpt-dir A:\\stable-diffusion')
...
def prepare_environment():
    ...
    commandline_args = os.environ.get('COMMANDLINE_ARGS',--skip-torch-cuda-test, "True")
